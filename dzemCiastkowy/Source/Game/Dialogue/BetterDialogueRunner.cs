...
/// </summary>
public class BetterDialogueRunner : Script
{
    ...
    public Story ActiveStory => _activeStory;
    ...
    {
        if (!_activeStory || !_activeStory.variablesState.Contains(name))
            return false;
    ...
    public bool GetVariable(string name, out int value)
    {
        if (GetVariable(name, out object val) && val is int i)
        {
            value = i;
            return true;
        }
    ...
    public bool GetVariable(string name, out float value)
    {
        if (GetVariable(name, out object val) && val is float i)
        {
            value = i;
            return true;
        }
    ...
    public bool GetVariable(string name, out string value)
    {
        if (GetVariable(name, out object val) && val is string i)
        {
            value = i;
            return true;
        }
    ...
    {
        if (GetVariable(name, out object val) && val is bool i)
        {
            value = i;
            return true;
        }
